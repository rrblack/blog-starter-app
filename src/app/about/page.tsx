    ...
    <main>
      <Container >
        ...
        <div className="md:mt-36 mt-2"> 
          <h1 className="md:-mt-20 text-center text-7xl md:text-8xl mb-12"> Hi, I'm Kyle </h1>
      ...
      <p className="flex items-center md:text-center text-lg md:text-xl md:text-wrap mt-10 md:mt-10 mx-5 md:mx-60 mb-10 md:mb-15"> 
