...
import ProseWithLightbox from "@/app/_components/lightbox-component";
      ...
      <Container>
        ...
        <article className="mb-32">
          ...
          <div className="flex justify-center">
            <div className="prose prose-lg prose-invert max-w-3xl w-full px-4 text-white prose-img:rounded-lg prose-img:max-xl prose-a:text-red-500 hover:prose-a:text-red-400 transition-colors duration-200 prose-video:rounded-lg prose-blockquote:border-l-red-500 ">
              {post.content}
            </div>
          </div>
        </article>
